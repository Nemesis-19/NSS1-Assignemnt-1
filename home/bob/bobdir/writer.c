...
int main(int argc, char *argv[]) {
    ...
    char *data = "This is ACL file for bobdir directory. Modify only if you know what you are doing.";
    file->data_len = strlen(data) + 1;
    file->data = strdup(data);

    write_file("bobdir_acl", file);
